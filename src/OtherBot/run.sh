...
# Run Game
echo "Running Game..."
java -jar ../shared/tools/PlayGame.jar ../shared/tools/maps/8planets/map3.txt "java OtherBot" "java BullyBot" serial 100 1000 | python ../shared/tools/visualizer/visualize_locally.py
